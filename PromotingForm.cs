...
namespace Chess
{
    public partial class PromotingForm : Form
    {
        ...
        private void StyleButtons(PieceColors pieceColor)
        {
            ...
            {
                btnKnight.BackgroundImage = Properties.Resources.wN;
                btnBishop.BackgroundImage = Properties.Resources.wB;
                btnQueen.BackgroundImage = Properties.Resources.wQ;
                btnRook.BackgroundImage = Properties.Resources.wR;
            }
            else
            {
                btnKnight.BackgroundImage = Properties.Resources.bN;
                btnBishop.BackgroundImage = Properties.Resources.bB;
                btnQueen.BackgroundImage = Properties.Resources.bQ;
                btnRook.BackgroundImage = Properties.Resources.bR;
            }
