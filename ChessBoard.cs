...
namespace Chess
{
    internal class ChessBoard : TableLayoutPanel
    {
        ...
        public void ArrangePieces()
        {
            for (int i = 0; i < 8; i++)
            {
                cell[1, i].BackgroundImage = Properties.Resources.bP;
                cell[6, i].BackgroundImage = Properties.Resources.wP;
            ...
            cell[0, 0].BackgroundImage = cell[0, 7].BackgroundImage = Properties.Resources.bR;
            cell[7, 0].BackgroundImage = cell[7, 7].BackgroundImage = Properties.Resources.wR;
            cell[0, 0].PieceType = cell[0, 7].PieceType = cell[7, 0].PieceType = cell[7, 7].PieceType = PieceTypes.Rook;

            cell[0, 1].BackgroundImage = cell[0, 6].BackgroundImage = Properties.Resources.bN;
            cell[7, 1].BackgroundImage = cell[7, 6].BackgroundImage = Properties.Resources.wN;
            cell[0, 1].PieceType = cell[0, 6].PieceType = cell[7, 1].PieceType = cell[7, 6].PieceType = PieceTypes.Knight;

            cell[0, 2].BackgroundImage = cell[0, 5].BackgroundImage = Properties.Resources.bB;
            cell[7, 2].BackgroundImage = cell[7, 5].BackgroundImage = Properties.Resources.wB;
            cell[0, 2].PieceType = cell[0, 5].PieceType = cell[7, 2].PieceType = cell[7, 5].PieceType = PieceTypes.Bishop;

            cell[0, 3].BackgroundImage = Properties.Resources.bQ;
            cell[7, 3].BackgroundImage = Properties.Resources.wQ;
            cell[0, 3].PieceType = cell[7, 3].PieceType = PieceTypes.Queen;

            cell[0, 4].BackgroundImage = Properties.Resources.bK;
            cell[7, 4].BackgroundImage = Properties.Resources.wK;
